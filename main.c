  ...
  while (1) {
    ...
    if (current_builtin != BUILTIN_NONE) {
      ...
      switch (current_builtin) {
        ...
        case BUILTIN_DECLARE: { name = "declare"; break; }
        case BUILTIN_CD:      { name = "cd";      break; }
        case BUILTIN_PUSHD:   { name = "pushd";   break; }
        case BUILTIN_POPD:    { name = "popd";    break; }
        case BUILTIN_HELP:    { name = "help";    break; }
